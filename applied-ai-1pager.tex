...
\section{Profile}
\resumeItemListStart
\resumeItem{Senior Software Architect specializing in production-grade AI systems\textemdash{}agentic AI, RAG, and natural-language interfaces\textemdash{}with a track record of leading cross-functional engineering teams to deliver scalable solutions.}
...
\resumeItemListStart
\resumeItem{Leading development of \textbf{AI-native applications} and \textbf{custom agentic AI systems} within Teleperformance's AI Engineering team.}
\resumeItemListEnd
...
\resumeItem{Established \textbf{architecture and development standards} for \textbf{22 developers across 5 teams}, leading org-wide coordination for \textbf{80+ engineers} and driving \textbf{40\% velocity improvement, 60\% rework reduction, and zero missed deliveries} over 2+ years.}
\resumeItemListEnd
...
\resumeItemListStart
\resumeItem{Cut multi-day payroll discrepancy review to \textbf{under 2 hours} by building automation that analyzed \textbf{1.5M Amazon weekly and monthly payrolls}.}
